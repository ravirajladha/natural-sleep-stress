...
<body>
	...
	<div id="conent">
		...
		<img id="logo2" class="ribbon" src="<?php echo URLROOT; ?>/assets/natural_logo.png" alt="" width="130" style="padding:30px;float:right">
	</div><br><br><br>
	...
	<div class="course" style="text-align:left;">
		...
		<div class="course-preview">
			...
			if($sleep){
				if($sleep<=25) {
					...
					$rec_val = "Hurray!! You are getting good sleep, Keep It Up!";
				}
				else if($sleep<=50) {
					echo "<img src='".URLROOT."/assets/resultc.png' width='350'>"; 
					$rec_val = "Your sleep quality needs improvement. Based on the clinical study results, subjects on HOLIXER™ experienced improved sleep quality after 8 weeks of consumption.";
				}
				else if($sleep<=75) {
					...
					$rec_val = "Your sleep quality needs immediate attention. Based on the clinical study results, subjects on HOLIXER™ experienced improved sleep quality after 8 weeks of consumption.";
				}
				}
			?>
		<br><br>
			<ul>
				<li>0 - 25 : Healthy sleep</li>
				<li>26 - 50 :  Moderate Sleep</li>
				<li>51 - 75 : Needs improvement</li>
				<li>76 - 100 : Good practice required</li>
			</ul>
		...
		<div class="course-info">
            ...
            <div class="row">
                ...
                <h4>   <?php
            if($sleep){
            if($sleep<=25) {echo "Healthy Sleep"; }
            else if($sleep<=50) {echo "Moderate Sleep"; }
			else if($sleep<=75) {echo "Needs Improvement"; }
            else {echo "Good Practice Required"; }
            }?></h4>
			...
			<br>
						...
						<div class="row">
							...
							<div class="col-md-7" id="mail_div1">
								<input class="btn" id="user_mail" name="mail" type="text" placeholder="Enter Email ID">
							</div>
							<div class="col-md-5" id="mail_div2" onclick="mail();">
								<input class="btn" type="submit" value="Mail Me" formtarget="_blank" />
							</div>
...
function mail(){
	...
	$.ajax({
		url  : "<?php echo URLROOT; ?>/test/mail_sleep/"+mail+"/<?php echo $sleep; ?>",
		type : 'POST',
	});
}
...
<br>
            <div class="row" style="margin-bottom:50px;">
				...
				<div class="col-md-3">
					<a href="<?php echo URLROOT; ?>/test/sleep/1"><button class="btn2">Retake Test</button></a>	
				</div>
                <div class="col-md-3">
					<a href="<?php echo URLROOT; ?>/test/stress/1"><button class="btn2">Take Stress Test</button>	</a>
				</div>
